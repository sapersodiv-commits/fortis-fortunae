...
$sql = "SELECT * FROM `races` WHERE `id` = ".$_GET['id'];
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="raceinfo.css">
	<link type="images/png" rel="icon" href="images/logo.png">
	<title><?foreach ($rows as $value){?><?=$value['name']?><?}?> / Расы / Fortis Fortunae</title>
</head>
<body>
	<header>
		<div class="head">
	...
	<main>
		<div class="buttons">
			<a href="races.php"><button class="button7"><p>Назад</p></button></a>
		</div>
			<div class="tabs_body">
